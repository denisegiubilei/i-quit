...
class FutureSlider extends React.Component {
  ...
  componentWillReceiveProps(nextProps) {
    ...
    let moneySaved = this.getMoneySaved(
      days,
      nextProps.pricePerPack,
      nextProps.packsPerWeek
    );
  ...
  handleChange = percentage => {
    ...
    let moneySaved = this.getMoneySaved(
      days,
      this.state.pricePerPack,
      this.state.packsPerWeek
    );
